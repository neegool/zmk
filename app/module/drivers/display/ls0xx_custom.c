...
static int ls0xx_init(const struct device *dev) {
    ...
    data->extcomin_thread_id = k_thread_create(
...
DEVICE_DT_INST_DEFINE(0, ls0xx_init, PM_DEVICE_DT_INST_GET(0), &ls0xx_data, &ls0xx_config,
                      POST_KERNEL, CONFIG_DISPLAY_INIT_PRIORITY, &ls0xx_driver_api);
